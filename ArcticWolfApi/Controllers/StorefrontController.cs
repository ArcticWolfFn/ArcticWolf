using ArcticWolfApi.Models.Storefront;
...
{
    [Route("fortnite/api/[controller]/v2")]
    [ApiController]
    public class StorefrontController : ControllerBase
    {
        [HttpGet("keychain")]
        public ActionResult<List<string>> GetKeychain() => (ActionResult<List<string>>)new List<string>()
    {
      ...
      "C60475E046D0F0FBCFE6DE6F9E040E0E:Wc6IzWuqnm7EHqcSx14i6KwXwl4+PmQq180ESMdR+08="
        ...
        [HttpGet("catalog")]
        public ActionResult<Catalog> GetCatalog() => (ActionResult<Catalog>)new Catalog();
    }
}
