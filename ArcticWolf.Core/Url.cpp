...
Uri Uri::Parse(const std::string_view& uri)
{
	Uri result;
...
std::string Uri::CreateUri(std::string_view Protocol, std::string_view Host, std::string_view Port, std::string_view Path, std::string_view QueryString)
{
...
constexpr std::string_view Uri::make_string_view(const std::string_view& base, iterator_t first, iterator_t last)
{
